...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.4 -->
    <link href="<?= Html::encode($assets_url).'css/admin/'; ?>bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- FontAwesome 4.3.0 -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!-- Ionicons 2.0.0 -->
    <link href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="<?= Html::encode($assets_url).'css/admin/'; ?>AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link href="<?= Html::encode($assets_url).'css/admin/'; ?>skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
  </head>
  ...
  <body class="skin-blue sidebar-mini">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?= Html::encode($assets_url).'images/admin/' ?>user2-160x160.jpg" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?= Html::encode($assets_url).'images/admin/' ?>user3-128x128.jpg" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?= Html::encode($assets_url).'images/admin/' ?>user4-128x128.jpg" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?= Html::encode($assets_url).'images/admin/' ?>user2-160x160.jpg" class="user-image" alt="User Image" />
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="<?= Html::encode($assets_url).'images/head_images/'.Html::encode($session['head_image']) ?>" class="img-circle" alt="User Image" />
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> 教员库</a></li>
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?= Html::encode($assets_url).'plugins/' ?>jQuery-2.1.4.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?= Html::encode($assets_url).'js/admin/' ?>bootstrap.min.js" type="text/javascript"></script>
    
    <!-- AdminLTE App -->
    <script src="<?= Html::encode($assets_url).'js/admin/' ?>app.min.js" type="text/javascript"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="<?= Html::encode($assets_url).'js/admin/' ?>pages/dashboard.js" type="text/javascript"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="<?= Html::encode($assets_url).'js/admin/' ?>demo.js" type="text/javascript"></script>
